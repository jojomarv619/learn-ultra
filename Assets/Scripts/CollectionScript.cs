...
public class CollectionScript : MonoBehaviour
{
    ...
    [SerializeField] private Transform viewGO;
    [SerializeField] public GameObject viewItemImg;
    private bool isPanelClosed;
    public GameObject viewItemObject;
    ...
    public void openBuyPanel(string itemName, int itemCost, Sprite itemImage)
    {
        ...
        viewItemObject = Instantiate(viewItemImg, viewGO);

        //change sprite alpha
        viewItemObject.transform.GetChild(0).GetComponent<Image>().sprite = itemImage;
