...
public class GameControllerForReadingCompScript : MonoBehaviour
{
    [SerializeField]
                        ...
                        using (UnityWebRequest www = UnityWebRequest.Post("http://learnplusultra.xyz/app_scripts/insertgamedata.php", form))
                        {
                            ...
                            else
                            {
                                ...
                                if (text != null)
                                {
                                    ...
                                    if (gameType == "reading_comp")
                                    {
                                        DBManager.currentRCStage = "25";
                                    }
                        ...
                        using (UnityWebRequest www = UnityWebRequest.Post("http://learnplusultra.xyz/app_scripts/insertgamedata.php", form))
                        {
                            ...
                            else
                            {
                                ...
                                if (text != null)
                                {
                                    ...
                                    if (gameType == "reading_comp")
                                    {
                                        var dbStage = int.Parse(DBManager.currentRCStage);

                                        if (dbStage >= nextNumber)
                                        {
                                            DBManager.currentRCStage = dbStage.ToString();
                                        }

                                        else
                                        {
                                            DBManager.currentRCStage = nextNumber.ToString();
                                        }
                                    }
                                }
