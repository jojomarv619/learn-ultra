...
public class GameControllerForLetterSoundsScript : MonoBehaviour
{
    [SerializeField]
                        ...
                        using (UnityWebRequest www = UnityWebRequest.Post("http://learnplusultra.xyz/app_scripts/insertgamedata.php", form))
                        {
                            ...
                            else
                            {
                                ...
                                if (text != null)
                                {
                                    ...
                                    if (gameType == "letter_sounds")
                                    {
                                        var dbStage = int.Parse(DBManager.currentLSStage);

                                        if (dbStage >= nextNumber)
                                        {
                                            DBManager.currentLSStage = dbStage.ToString();
                                        }

                                        else
                                        {
                                            DBManager.currentLSStage = nextNumber.ToString();
                                        }
                                    }
                                }
