...
public class GameControllerForSpellingScript : MonoBehaviour
{
    [SerializeField]
                        ...
                        using (UnityWebRequest www = UnityWebRequest.Post("http://learnplusultra.xyz/app_scripts/insertgamedata.php", form))
                        {
                            ...
                            else
                            {
                                ...
                                if (text != null)
                                {
                                    ...
                                    if (gameType == "spelling")
                                    {
                                        var dbStage = int.Parse(DBManager.currentSPStage);

                                        if (dbStage >= nextNumber)
                                        {
                                            DBManager.currentSPStage = dbStage.ToString();
                                        }

                                        else
                                        {
                                            DBManager.currentSPStage = nextNumber.ToString();
                                        }
                                    }
                                }
